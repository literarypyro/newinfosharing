...
<a href='#' class="two" onclick='window.open("generate_star.php?star_id=<?php echo $timetable_code; ?>&timetable=<?php echo $timetable; ?>");'><b>Generate Printout</b></a>

<br>

<a href='#' class="two" onclick='window.open("generate_ccip.php?ccip_id=<?php echo $timetable_code; ?>&ccip_date=<?php echo $timetable; ?>");'><b>Generate Insertion Form</b></a>
