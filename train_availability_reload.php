...
<!-- --- Variant A: reload train_availability on close -------------------
     Simple: whenever the modal closes (via x, Cancel, Esc, or backdrop),
     reload the parent page so any edits made in the iframe are reflected
     in the "IN ####" links and their surrounding row context. Losing
     scroll position and any unsubmitted form state on this page is the
     tradeoff.
     ------------------------------------------------------------------- -->
<script type="text/javascript">
