...
<body class="DBody">      
    <br>
    <br>
    <a class='two' href='Tmenu.php'><font face="Century" size="4"><b>Back to Main Menu</b></font></a>  
    <br>
    <br>    
    <table id="dg" title="Transport Employees" class="easyui-datagrid" style="width:100%;height:350px"
       ...
       <thead>
            <tr>                                                                                  
                ...
                <th field="empNum" width="50">Employee No.</th>
    ...
    <div id="toolbar" >
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">New Employee</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" onclick="editUser()">Edit User</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" onclick="destroyUser()">Remove User</a>
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px;height:300px;padding:5px 5px"
        ...
        <form id="fm" method="post" novalidate>        
            ...
            <div class="fitem">
                ...
                <input name="empNum" class="easyui-numberbox" value="100">                
            </div>        
            <div class="fitem">
