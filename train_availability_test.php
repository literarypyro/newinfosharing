...
?>
		<td align=center rowspan=4><?php echo $row3['new_index']." /<br> ".date("H:i",strtotime($row3['date_change'])); ?> <a href='#' class="<?php echo $SRemove5; ?>"  onclick='deleteSwitch("<?php echo $row3['id']; ?>")'>X</a> </td>
<?php
	...
	for($n=0;$n<$blank;$n++){	
		if($n==0){
			?>	
		<td rowspan=4><a href='#add_form' class="<?php echo $SRemove; ?>"  onclick='changeForm("index_switch","<?php echo $row['id']; ?>","")'>Switch Index No.</a></td>
			<?php
		}
		else {
?>
