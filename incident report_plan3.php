...
function cFilterSearch(q){
	irSearchIncidents(q,function(data){
		var filtered=data.filter(function(r){
			if(cTabFilter==='all') return true;
			if(cTabFilter==='today') return r.date==='<?php echo date("Y-m-d"); ?>';
	...
	<div class="ir-modal-box">
		...
		<div class="ir-modal-body">
			...
			<div class="ir-filter-tabs" id="c-tabs">
				<button class="ir-filter-tab active" type="button" onclick="cSetTab(this,'all')">All</button>
				<button class="ir-filter-tab" type="button" onclick="cSetTab(this,'today')">Today</button>
				<button class="ir-filter-tab" type="button" onclick="cSetTab(this,'rolling')">Rolling Stock</button>
				<button class="ir-filter-tab" type="button" onclick="cSetTab(this,'power')">Power</button>
				<button class="ir-filter-tab" type="button" onclick="cSetTab(this,'l3')">Level 3+</button>
			</div>
			<!-- Results -->
