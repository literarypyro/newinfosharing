...
echo "style='background-color:#67c2ef'";
 ...
 echo "style='background-color:#67c2ef'";
		...
		?>
		>
		<td align=center rowspan=4><?php echo $row['index_no']; ?> <a href='#' class="<?php echo $SRemove4; ?>" onclick='changeForm("editIndex","<?php echo $row['id']; ?>","")'>Edit</a></td>
<?php
...
?>
<td align=center rowspan=4 class="switch-cell" data-switch-id="<?php echo $row3['id']; ?>"><?php echo $row3['new_index']." /<br> ".date("H:i",strtotime($row3['date_change'])); ?> <a href='#' class="<?php echo $SRemove5; ?>"  onclick='deleteSwitch("<?php echo $row3['id']; ?>")'>X</a> </td>
<?php
	...
	for($n=0;$n<$blank;$n++){	
		if($n==0){
			?>	
<td rowspan=4 class="switch-placeholder" data-train-id="<?php echo $row['id']; ?>"><a href='#add_form' class="<?php echo $SRemove; ?>"  onclick='changeForm("index_switch","<?php echo $row['id']; ?>","")'>Switch Index No.</a></td>			<?php
		}
		else {
?>
		<td rowspan=4>&nbsp;</td>
...
?>	
		<td align=center><a href='#' class="<?php echo $SRemove?>"  onclick='window.open("car_history.php?car_id=<?php echo $row['car_a']; ?>")'><?php echo $row['car_a']; ?></a></td><td rowspan=4><a href='#add_form' class="<?php echo $SRemove4?>"  onclick='changeForm("editCar","<?php echo $row['id']; ?>","")'>Edit</a></td>
	<?php	
...
//						$level2Clause="&nbsp;";						
	...
	?>
		...
		<td align=center rowspan=4><?php echo $row['lpam_id']; ?></td>		

		<td rowspan=4><?php echo $inserted_to.$insert_time; ?> <a href='#add_form' class="<?php echo $SRemove4; ?>" onclick='changeForm("insertion","<?php echo $row['id']; ?>","<?php if($row['type']=="unimog"){ echo "unimog"; } else if($row['type']=="test"){ echo "test"; } else if($row['type']=="reserve"){ echo "reserve"; } else if($row['type']=="schooling"){ echo "schooling"; } ?>")'>Edit</a> / <a href='#'  class="<?php echo $SRemove; ?>" onclick='cancelTrain("<?php echo $row['id']; ?>")'>Cancel</a></td>
		<td rowspan=4><?php echo str_replace("SUP","STDO",$insert_driver); ?></td>

<!--<a href='#' onclick='changeForm("index_switch","")'>Switch Index No.</a>-->
		<td rowspan=4><?php echo $removed_from.$remove_time; ?> <a href='#add_form'  class="<?php echo $SRemove4; ?>" onclick='changeForm("removal","<?php echo $row['id']; ?>","<?php if($row['type']=="unimog"){ echo "unimog"; } else if($row['type']=="test"){ echo "test"; } else if($row['type']=="reserve"){ echo "reserve"; } else if($row['type']=="schooling"){ echo "schooling"; } ?>")'>Edit</a></td>
		<td rowspan=4><?php echo str_replace("SUP","STDO",$remove_driver); ?></td>
...
//			echo "style='background-color:#f5f5f5;';";
	...
	>
		<td align=center><a href='#'  class="<?php echo $SRemove; ?>" onclick='window.open("car_history.php?car_id=<?php echo $row['car_d']; ?>")'><?php echo $row['car_d']; ?></a></td>
