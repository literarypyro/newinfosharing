...
<div class="ir-page">
	...
	<tr>
		<td class="ir-label">Link Incident Report</td>
		<td class="ir-field ir-inline" style="gap:8px">
			<input type='text' class="ir-input--md" name='incident_no_link' id='incident_no_link' />
